...
Source0  : https://download.gnome.org/sources/vte/0.78/vte-0.78.2.tar.xz
...
%prep
%setup -q -n vte-0.78.2
cd %{_builddir}/vte-0.78.2
%patch -P 1 -p1
pushd ..
cp -a vte-0.78.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1732467302
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libvte-2.91.so.0.7800.2
/usr/lib64/libvte-2.91.so.0
/usr/lib64/libvte-2.91.so.0.7800.2
