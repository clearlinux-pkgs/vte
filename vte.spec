...
Source0  : https://download.gnome.org/sources/vte/0.78/vte-0.78.3.tar.xz
...
%prep
%setup -q -n vte-0.78.3
cd %{_builddir}/vte-0.78.3
%patch -P 1 -p1
pushd ..
cp -a vte-0.78.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1737997310
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libvte-2.91.so.0.7800.3
/usr/lib64/libvte-2.91.so.0
/usr/lib64/libvte-2.91.so.0.7800.3
