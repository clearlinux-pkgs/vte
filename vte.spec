...
Source0  : https://download.gnome.org/sources/vte/0.67/vte-0.67.90.tar.xz
...
%prep
%setup -q -n vte-0.67.90
cd %{_builddir}/vte-0.67.90
%patch1 -p1
pushd ..
cp -a vte-0.67.90 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1648057791
...
cp %{_builddir}/vte-0.67.90/COPYING.CC-BY-4-0 %{buildroot}/usr/share/package-licenses/vte/c0e2f3021a02d71ef52b88aac2ed98c996d7517d
cp %{_builddir}/vte-0.67.90/COPYING.GPL3 %{buildroot}/usr/share/package-licenses/vte/a742ddd48b78f2a7a13ac678ce5ecacf93c771ee
cp %{_builddir}/vte-0.67.90/COPYING.LGPL3 %{buildroot}/usr/share/package-licenses/vte/e203d4ef09d404fa5c03cf6590e44231665be689
cp %{_builddir}/vte-0.67.90/COPYING.XTERM %{buildroot}/usr/share/package-licenses/vte/704ec162c7e726301bf2b873fa99052b40250a99
...
/usr/lib64/libvte-2.91.so.0.6790.0
