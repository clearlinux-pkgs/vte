...
%prep
%setup -q -n vte-0.60.2
cd %{_builddir}/vte-0.60.2
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1588088565
...
cp %{_builddir}/vte-0.60.2/COPYING.GPL3 %{buildroot}/usr/share/package-licenses/vte/e31db874e5b375f0592b02e3e450c9e94086e661
cp %{_builddir}/vte-0.60.2/COPYING.LGPL2 %{buildroot}/usr/share/package-licenses/vte/01a6b4bf79aca9b556822601186afab86e8c4fbf
cp %{_builddir}/vte-0.60.2/COPYING.LGPL3 %{buildroot}/usr/share/package-licenses/vte/e203d4ef09d404fa5c03cf6590e44231665be689
...
/usr/lib64/libvte-2.91.so.0.6000.2
