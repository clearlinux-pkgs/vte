...
Source0  : https://download.gnome.org/sources/vte/0.58/vte-0.58.3.tar.xz
...
%prep
%setup -q -n vte-0.58.3
cd %{_builddir}/vte-0.58.3
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1576534563
...
cp %{_builddir}/vte-0.58.3/COPYING.GPL3 %{buildroot}/usr/share/package-licenses/vte/e31db874e5b375f0592b02e3e450c9e94086e661
cp %{_builddir}/vte-0.58.3/COPYING.LGPL2 %{buildroot}/usr/share/package-licenses/vte/01a6b4bf79aca9b556822601186afab86e8c4fbf
cp %{_builddir}/vte-0.58.3/COPYING.LGPL3 %{buildroot}/usr/share/package-licenses/vte/e203d4ef09d404fa5c03cf6590e44231665be689
