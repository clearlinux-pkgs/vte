...
Source0  : https://download.gnome.org/sources/vte/0.70/vte-0.70.3.tar.xz
...
%prep
%setup -q -n vte-0.70.3
cd %{_builddir}/vte-0.70.3
%patch1 -p1
pushd ..
cp -a vte-0.70.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1676473802
...
/usr/lib64/glibc-hwcaps/x86-64-v3/libvte-2.91.so.0.7000.3
/usr/lib64/libvte-2.91-gtk4.so.0
/usr/lib64/libvte-2.91.so.0
/usr/lib64/libvte-2.91.so.0.7000.3
