...
Version  : 0.56.1
Release  : 33
URL      : https://github.com/GNOME/vte/archive/0.56.1/vte-0.56.1.tar.gz
Source0  : https://github.com/GNOME/vte/archive/0.56.1/vte-0.56.1.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1554773169
...
/usr/lib64/libvte-2.91.so.0.5600.1
