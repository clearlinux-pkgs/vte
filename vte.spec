...
Source0  : http://ftp.gnome.org/pub/GNOME/sources/vte/0.46/vte-0.46.1.tar.xz
...
%prep
%setup -q -n vte-0.46.1

%build
export LANG=C
export SOURCE_DATE_EPOCH=1483202559
...
/usr/lib64/libvte-2.91.so.0.4600.1
