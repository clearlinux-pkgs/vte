...
Source0  : https://github.com/GNOME/vte/archive/0.54.1.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1537841798
...
export SOURCE_DATE_EPOCH=1537841798
rm -rf %{buildroot}
mkdir -p %{buildroot}/usr/share/doc/vte
cp COPYING.GPL3 %{buildroot}/usr/share/doc/vte/COPYING.GPL3
cp COPYING.LGPL2 %{buildroot}/usr/share/doc/vte/COPYING.LGPL2
cp COPYING.LGPL3 %{buildroot}/usr/share/doc/vte/COPYING.LGPL3
%make_install
%find_lang vte-2.91
...
/usr/lib64/libvte-2.91.so.0.5400.1

%files license
%defattr(0644,root,root,0755)
/usr/share/doc/vte/COPYING.GPL3
/usr/share/doc/vte/COPYING.LGPL2
/usr/share/doc/vte/COPYING.LGPL3
