...
%prep
%setup -q -n vte-0.70.2
cd %{_builddir}/vte-0.70.2
%patch1 -p1
pushd ..
cp -a vte-0.70.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1670510150
...
/usr/lib64/glibc-hwcaps/x86-64-v3/libvte-2.91.so.0.7000.2
/usr/lib64/libvte-2.91-gtk4.so.0
/usr/lib64/libvte-2.91.so.0
/usr/lib64/libvte-2.91.so.0.7000.2
