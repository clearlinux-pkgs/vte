...
%prep
%setup -q -n vte-0.76.3
cd %{_builddir}/vte-0.76.3
%patch -P 1 -p1
pushd ..
cp -a vte-0.76.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1718228307
...
/V3/usr/lib64/libvte-2.91.so.0.7600.3
/usr/lib64/libvte-2.91-gtk4.so.0
/usr/lib64/libvte-2.91.so.0
/usr/lib64/libvte-2.91.so.0.7600.3
