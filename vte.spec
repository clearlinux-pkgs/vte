...
Source0  : https://download.gnome.org/sources/vte/0.76/vte-0.76.0.tar.xz
...
%prep
%setup -q -n vte-0.76.0
cd %{_builddir}/vte-0.76.0
%patch -P 1 -p1
pushd ..
cp -a vte-0.76.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1710784127
...
/V3/usr/lib64/libvte-2.91.so.0.7600.0
/usr/lib64/libvte-2.91-gtk4.so.0
/usr/lib64/libvte-2.91.so.0
/usr/lib64/libvte-2.91.so.0.7600.0
