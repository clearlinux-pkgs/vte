...
Source0  : https://download.gnome.org/sources/vte/0.60/vte-0.60.3.tar.xz
...
%prep
%setup -q -n vte-0.60.3
cd %{_builddir}/vte-0.60.3
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1591116484
...
cp %{_builddir}/vte-0.60.3/COPYING.CC-BY-4-0 %{buildroot}/usr/share/package-licenses/vte/c0e2f3021a02d71ef52b88aac2ed98c996d7517d
cp %{_builddir}/vte-0.60.3/COPYING.GPL3 %{buildroot}/usr/share/package-licenses/vte/e31db874e5b375f0592b02e3e450c9e94086e661
cp %{_builddir}/vte-0.60.3/COPYING.LGPL2 %{buildroot}/usr/share/package-licenses/vte/01a6b4bf79aca9b556822601186afab86e8c4fbf
cp %{_builddir}/vte-0.60.3/COPYING.LGPL3 %{buildroot}/usr/share/package-licenses/vte/e203d4ef09d404fa5c03cf6590e44231665be689
...
/usr/lib64/libvte-2.91.so.0.6000.3
